...
export default function Banner() {
  ...
  return (
    <div className="pt-28 px-4 md:px-8 border-b-2 border-dotted border-gray-300 pb-8 flex flex-col md:flex-row gap-4 bg-white relative z-0">
      ...
      <div className="md:w-1/2 grid grid-cols-2 grid-rows-2 gap-2 h-[500px]">
        {rightBanners.map((banner, idx) => (
          ...
          >
            ...
            <div className={`absolute inset-0 flex flex-col justify-center items-start bg-black/30 px-4 transition-opacity duration-300
